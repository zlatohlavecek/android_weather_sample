...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        long watherId = database.insert(WeatherContract.WeatherEntry.TABLE_NAME, null, weatherValues);
    ...
    public long insertLocation() {
        ...
        if (id == -1) {
            fail("Not inserted data to location table");
        }

        // Query the database and receive a Cursor back
        Cursor cursor = database.query(WeatherContract.LocationEntry.TABLE_NAME,  // Table to Query
                null, // all columns
